...
( new GitHub_Plugin_Updater( plugin_basename( __FILE__ ), '1.0.1', 'https://api.github.com/crftwrk/bs-simple-notice' ) )->init();
...
function my_function() {
  echo '<div class=""><p class="alert alert-info">bS Simple Notice has been updated to v1.0.1</p></div>';
}
